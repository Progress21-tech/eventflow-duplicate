    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        <div className="flex items-center gap-3">
          {/* Label */}
          <div className="bg-white rounded-full px-4 py-2 shadow-[0_4px_16px_rgba(0,0,0,0.12)] flex flex-col items-center leading-tight">
            <span className="text-[#111] text-xs">More inquiries?</span>
            <span className="text-[#25D366] text-xs font-bold">Chat with us now</span>
          </div>
