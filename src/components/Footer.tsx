      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://www.linkedin.com/company/eventflowafrica" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-ef-lime transition-colors" aria-label="LinkedIn">
