...
import CMSCaseStudiesSection from "@/components/cms/CMSCaseStudiesSection";
...
>
    {caseStudies.map((study, idx) => (
      ...
      >
        ...
        />
        {/* Top overlay — dark blue tint so title text is readable */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(to bottom, rgba(1,5,100,0.70) 0%, rgba(1,5,100,0.20) 50%, transparent 70%)",
          }}
        />
        {/* Bottom overlay so CTA button is readable */}
